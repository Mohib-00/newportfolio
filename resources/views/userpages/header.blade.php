 ...
 @keyframes rotate3D {
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light d-lg-none">
        <div class="container-fluid container-md d-flex">
            <a href="#" onclick="loadPage(); return false;">
                <img class="header-logoo" src="{{ asset('images/' . $settings->logo) }}" alt="MP small icon" style="min-width:60%;height:60px;">
            </a>
            <div class="">
                <a class="btn btn-primary text-white btn-sm theme-btn-radius theme-solid-btn nav-btn" href="#" onclick="loadSelectAppPage(); return false;">Get&nbsp;Started</a>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item dropdown-color" href="#" onclick="loadFeatureDetails('{{ Str::slug($feature->heading) }}'); return false;">{{$feature->heading}}</a></li>
                            @endforeach
                        </ul>
                    </li>
                   
                    <li class="nav-item">
                        <a class="nav-link" href="#" onclick="loadBlogsPage(); return false;">Blogs</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#" onclick="loadContactPage(); return false;">Contact</a>
                    </li>
                    <li class="nav-item">
                        @if (auth()->check())
    ...
    <nav class="navbar navbar-expand-md navbar-light bg-white d-none d-lg-block py-3">
        <div class="container-fluid container-md mbl-header">
            <a class="navbar-brand" href="#" onclick="loadPage(); return false;">
                ...
                <ul class="nav navbar-nav ps-3 pl-sm-0">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            @foreach($features as $feature)
                            <li>
                                <a class="dropdown-item py-md-2" href="#" onclick="loadFeatureDetails('{{ Str::slug($feature->heading) }}'); return false;" style="color:gray;">
                                    {{ $feature->heading }}
                                </a>
                            </li>
                            @endforeach
                    ...
                    <li class="nav-item pe-md-3">
                        <a class="nav-link text-secondary" href="#" onclick="loadBlogsPage(); return false;">Blogs</a>
                    </li>
                    <li class="nav-item pe-md-3">
                        <a class="nav-link text-secondary" href="#" onclick="loadContactPage(); return false;">Contact</a>
                    </li>
                    <li class="nav-item pe-md-3">
                        @if (auth()->check())
                        <div class="nav-item dropdown">
                    ...
                    <li class="nav-item pe-md-3">
                        <a class="btn btn-primary nav-link text-white btn-sm theme-btn-radius theme-solid-btn nav-btn px-4 d-none d-sm-block" href="#" onclick="loadSelectAppPage(); return false;">Get Started</a>
                    </li>
                </ul>
            </div>
        </div>
...
{{--<section class="shadow sticky-index sticky-top">
 ...
 @keyframes rotate3D {
     ...
     <nav class="navbar navbar-expand-lg bg-white navbar-light d-lg-none">
        <div class="container-fluid container-md d-flex">
            <a href="/">
                <img class="header-logoo" src="{{ asset('public/images/' . $settings->logo) }}" alt="MP small icon" style="min-width:60%;height:60px;">
            </a>
            <div class="">
    ...
    <nav class="navbar navbar-expand-md navbar-light bg-white d-none d-lg-block py-3">
        <div class="container-fluid container-md mbl-header">
            <a class="navbar-brand" href="/">
                <img src="{{ asset('public/images/' . $settings->logo) }}" alt="Moneypex Footer logo" class="align-text-top header-logo" style="min-width:60%;height:70px;">
            </a>
            <button class="navbar-toggler border border-2 ms-3 border-0" type="button" data-bs-toggle="collapse" data-bs-target="#collapsibleNavbar">
                <img src="{{asset('index_files/menu-icon.svg')}}" id="toogle-menu-icon" alt="Toggle Menu Icon" onclick="toogleIconOpen()">
                <img src="{{asset('index_files/close-icon.svg')}}" id="menu-cross-icon" alt="Toggle Menu Icon" onclick="toogleIconClose()">
