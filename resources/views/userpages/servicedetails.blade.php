    ...
    <div class="container pt-sm-5">
        <div class="row px-xl-5">
            <div class="col-lg-7 px-4 px-lg-0 px-xl-4 ps-lg-5 order-2 pt-5 pt-lg-0">
                <h2 class="theme-color fs-1 service-section-sub-heading fw-bold">
                    @foreach ($servicesection5s as $section5)
                ...
                @foreach ($servicesection5s as $section5)
            <div class="d-flex py-3">
                <img style="border-radius:50%" class="services-inner-sectio-icon align-self-start" src="{{ asset('images/' . $section5->sub_image) }}" alt="Save Important Documents icon">
                <div class="ps-3">
            ...
            <div class="col-lg-5 ps-5 ps-lg-0 ps-xxl-5 d-lg-flex align-items-center order-lg-2">
                <img class="services-section-tab-one-col-one-image pe-lg-4 pe-xl-0" src="{{ asset('images/' . $section5->image) }}" alt="Hassle Free Inventory Management with moneypex">
            </div>
            @endif
            @endforeach
        </div>
    ...
    <div class="container">
        <div class="row px-xl-5">
            <div class="col-lg-7 px-4 px-lg-0 px-xl-4 pe-lg-5 order-2 order-lg-1 pt-5 pt-lg-0">
                ...
                <div class="d-flex py-3">
                    <img class="services-inner-sectio-icon align-self-start" src="./service_files/services - book keeping 5(a).png" alt="services - book keeping">
                    <div class="ps-3">
                ...
                <div class="d-flex mt-4">
                    <img class="services-inner-sectio-icon align-self-start" src="./service_files/Forecast Future icon.png" alt="Forecast Future icon">
                    <div class="ps-3">
                        <b>Forecast Future</b>
                        <p class="pe-lg-3 me-lg-3 pt-2">
            ...
            <div class="col-lg-5 ps-5 ps-lg-0 ps-xxl-5 d-lg-flex align-items-center order-lg-2">
                <img class="services-section-tab-one-col-one-image pe-lg-4 pe-xl-0" src="./service_files/Reports and Analysis.webp" alt="Reports and Analysis">
            </div>
        </div>
    </div>
</section>
<!-- ? services section end-->
<!-- ? Explore services section start-->
<section>
    <div class="container">
        ...
        <div class="row px-sm-5 px-3">
            <div class="col-md-6 col-lg-3">
                <a style="text-decoration:none !important;" href="https://moneypex.com/invoicing-software">
                    <div class="explore-more-service-card p-3">
                        <img src="./service_files/Unlimited-Free-Invoicing.webp" alt="Unlimited Free Invoicing" class="mx-auto d-block">
            ...
            <div class="col-md-6 col-lg-3 pt-3 pt-md-0">
                <a style="text-decoration:none !important;" href="https://moneypex.com/financial-reporting-software">
                    <div class="explore-more-service-card p-3">
                        <img src="./service_files/Financial-Reporting.webp" alt="financial reporting" class="mx-auto d-block">
            ...
            <div class="col-md-6 col-lg-3 pt-3 pt-md-4 pt-lg-0">
                <a style="text-decoration:none !important;" href="https://moneypex.com/expense-management-software">
                    <div class="explore-more-service-card p-3">
                        <img src="./service_files/Expense-Management.webp" alt="Expense Management" class="mx-auto d-block">
            ...
            <div class="col-md-6 col-lg-3 pt-3 pt-md-4 pt-lg-0">
                <a style="text-decoration:none !important;" href="https://moneypex.com/ocr-software">
                    <div class="explore-more-service-card p-3">
                        <img src="./service_files/Smart Scanning.webp" alt="Smart Scanning" class="mx-auto d-block">
