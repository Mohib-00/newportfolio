                        ...
                        <div class="table-responsive">
                          ...
                          >
                            ...
                            <tbody>
                                ...
                                @foreach($productdetailhighlights as $highlight)
...
<div id="loader" style="display: none">
   ...
   $(document).on('click', '.delhighlight', function() {
       ...
       Swal.fire({
           ...
           if (result.isConfirmed) {
               ...
               $.ajax({
                   url: '/delete-productdetailhighlight',
                   type: 'POST',
       ...
       $('#loader').show();
       $.ajax({
           url: "{{ route('productdetailhighlight.store') }}",
           type: "POST",
           data: formData,
           contentType: false,
           processData: false,
   ...
   $(document).on('click', '.edit-highlight-btn', function () {
       ...
       $('#loader').show();
       $.ajax({
           url: "{{ route('productdetailhighlight.show', '') }}/" + highlightId, 
           type: "GET",  
           success: function (response) {
   ...
   $('#highlighteditform').on('submit', function (e) {
       ...
       $.ajax({
           url: "{{ route('productdetailhighlight.update', '') }}/" + highlightId,  
           type: "POST",  
           data: formData,
           contentType: false, 
           processData: false, 
